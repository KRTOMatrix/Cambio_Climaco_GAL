...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h2>Cambio climático recente<br>Provincia da Coruña';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
var osm2 = new L.TileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
	minZoom: 0, 
	maxZoom: 13,
	attribution:'| <a href="https://www.fundacionmatrix.es"><strong>Fundación Matrix</strong></a>'
	});
...
},
{
	...
	children: [
	    ...
	    { label: "Variantes locais de tipos climáticos",layer: mapa15}
	           ]
},
...
*/
	...
	var htmlLegend12 = L.control.htmllegend({
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h4>"+  '&nbsp &nbsp 0,1 – 5'+"<\h4>",html: '',style: {'background-color': '#abe9ff','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
			    label:"<h4>"+  '&nbsp &nbsp  5,1 – 10'+"<\h4>",html: '',style: {'background-color': '#004cac','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
				label: "<h5>" +'<BR><i>Fonte: CLIMACO. Elaboración propia con datos da Axencia Estatal de Meteoroloxía (2020).<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
	...
	map.addControl(htmlLegend12);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Tipos de cambio climático, do período 1971-1990 ao período 1999-2018'+"<\h3>",
			layer: geojson13,
		image:'<img src="images/LOGO_GEN.png"',
...
/*
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
		    	...
		    	label:'<br><img src="images/reximes.jpg",></img><br>',
				IMG:"<h3>"+  ''+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
	...
	map.addControl(htmlLegend14);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Variantes locais de tipos climáticos.<br> período 1981-2010'+"<\h3>",
			layer: geojson15,
		image:'<img src="images/LOGO_GEN.png"',
